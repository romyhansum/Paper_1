...
#Achtung bei Frankreich: außer für FRY... wird nuts1 level verwendet. Daher muss auch auf dieses aufsummiert werden.
...
vote_nuts2_all <- vote_nuts2_all %>% #For France and some regions in Spain and Romania, added numbers for electorate etc. need to be corrected as not every party exists in every nuts2 unit.
  mutate(electorate=case_when(country=="France" & year=="2017" & nuts2=="FR1" ~ 7199479,
                              country=="France" & year=="2017" & nuts2=="FRB" ~ 1827716,
                              country=="France" & year=="2017" & nuts2=="FRC" ~ 2001387,
                              country=="France" & year=="2017" & nuts2=="FRD" ~ 2396930,
                              country=="France" & year=="2017" & nuts2=="FRE" ~ 4243009,
                              country=="France" & year=="2017" & nuts2=="FRF" ~ 3873030,
                              country=="France" & year=="2017" & nuts2=="FRG" ~ 2706546,
                              country=="France" & year=="2017" & nuts2=="FRH" ~ 2453666,
                              country=="France" & year=="2017" & nuts2=="FRI" ~ 4327055,
                              country=="France" & year=="2017" & nuts2=="FRJ" ~ 4186540,
                              country=="France" & year=="2017" & nuts2=="FRK" ~ 5415694,
                              country=="France" & year=="2017" & nuts2=="FRL" ~ 3566117,
                              country=="France" & year=="2017" & nuts2=="FRM" ~ 233532,
...
vote_nuts2_all <- vote_nuts2_all %>% #For France, added numbers for electorate etc. need to be corrected as not every party exists in every nuts2 unit.
  mutate(total_vote=case_when(country=="France" & year=="2017" & nuts2=="FR1" ~ 3570172,
                              country=="France" & year=="2017" & nuts2=="FRB" ~ 931050,
                              country=="France" & year=="2017" & nuts2=="FRC" ~ 1019665,
                              country=="France" & year=="2017" & nuts2=="FRD" ~ 1220088,
                              country=="France" & year=="2017" & nuts2=="FRE" ~ 2026338,
                              country=="France" & year=="2017" & nuts2=="FRF" ~ 1808757,
                              country=="France" & year=="2017" & nuts2=="FRG" ~ 1431864,
                              country=="France" & year=="2017" & nuts2=="FRH" ~ 1366158,
                              country=="France" & year=="2017" & nuts2=="FRI" ~ 2286136,
                              country=="France" & year=="2017" & nuts2=="FRJ" ~ 2174356,
                              country=="France" & year=="2017" & nuts2=="FRK" ~ 2684801,
                              country=="France" & year=="2017" & nuts2=="FRL" ~ 1677828,
                              country=="France" & year=="2017" & nuts2=="FRM" ~ 115221,
...
vote_nuts2_all <- vote_nuts2_all %>% #For France, added numbers for electorate etc. need to be corrected as not every party exists in every nuts2 unit.
  mutate(valid_vote=case_when(country=="France" & year=="2017" & nuts2=="FR1" ~ 3511021,
                              country=="France" & year=="2017" & nuts2=="FRB" ~ 909430,
                              country=="France" & year=="2017" & nuts2=="FRC" ~ 995858,
                              country=="France" & year=="2017" & nuts2=="FRD" ~ 1191210,
                              country=="France" & year=="2017" & nuts2=="FRE" ~ 1978706,
                              country=="France" & year=="2017" & nuts2=="FRF" ~ 1771266,
                              country=="France" & year=="2017" & nuts2=="FRG" ~ 1399055,
                              country=="France" & year=="2017" & nuts2=="FRH" ~ 1338607,
                              country=="France" & year=="2017" & nuts2=="FRI" ~ 2230569,
                              country=="France" & year=="2017" & nuts2=="FRJ" ~ 2119421,
                              country=="France" & year=="2017" & nuts2=="FRK" ~ 2638721,
                              country=="France" & year=="2017" & nuts2=="FRL" ~ 1644593,
                              country=="France" & year=="2017" & nuts2=="FRM" ~ 112494,
